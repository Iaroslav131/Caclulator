...
"border: none;")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/backspace_24dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.gridLayout.addWidget(self.btn_sub, 4, 0, 1, 1)
